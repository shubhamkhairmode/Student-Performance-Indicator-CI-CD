...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            #devide train dataset to independant and dependant features

            input_features_tarin_df = train_df.drop(columns=[target_column_name], axis=1)
            ...
            input_feature_train_arr = preprocessing_obj.fit_transform(input_features_tarin_df)
